  ...
  return (
    <div className="min-h-screen">
      <div className="pt-[76px] md:pt-[100px]">
        ...
        {/* Mission */}
        <Section title="Our Mission" variant="secondary">
          <p className="font-open text-base leading-7 text-white" style={{ marginBottom: '24px' }}>
        ...
        <Section title="Community Impact" variant="secondary">
          <div className="font-open text-base leading-7 text-white" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div>
              <h3 className="font-albert text-xl font-semibold text-white" style={{ marginBottom: '8px' }}>Mentorship and Networking</h3>
            ...
            <div>
              <h3 className="font-albert text-xl font-semibold text-white" style={{ marginBottom: '8px' }}>Financial Support for Players</h3>
            ...
            <div>
              <h3 className="font-albert text-xl font-semibold text-white" style={{ marginBottom: '8px' }}>Community Engagement & Charity</h3>
